...
#  Description: Tutorial Exercises 8
...
def countX(str):
    if ( len(str) == 0):
        ...
        return 1 + countX(str[1:len(str)])
    else:
        return 0 + countX(str[1:len(str)])
...
def countHi(str):
    if ( len(str) <= 1 ):
        ...
        return 1 + countHi(str[2:len(str)])
    else:
        return countHi(str[1:len(str)])
